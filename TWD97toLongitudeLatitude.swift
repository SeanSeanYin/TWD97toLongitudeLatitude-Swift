...
func twd97ToLongitudeLatitude (inout longitude : Double, inout latitude: Double) {
    ...
    // Split a series of multiplication into two parts for Xcode's performance suggestion 
